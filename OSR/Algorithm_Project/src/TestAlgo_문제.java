...
//		total = 0;
//		permutationSelectedBitMasking(0, 0);
//		System.out.println("개수 : " + total);

//		System.out.println("■■■05. 중복순열 nπr");
//		total = 0;
...
//		System.out.println("회수 : " + total);
	 ...
	 */
	public static void permutationSelectedBitMasking(int index, int flag) {
	}

	/**
	 * 중복순열 nπr : index 위치에 사용하지 않은 숫자를 하나씩 넣어보는 재귀함수 N, R, total : 전역변수, input배열에서
	 * 선택한 값을 numbers배열에 저장, 만든 중복순열 마지막에 출력
	 */
